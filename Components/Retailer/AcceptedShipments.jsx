...
export default ({ getAcceptedProductDetailsModal, setGetAcceptedProductDetailsModal, getAcceptedProductDetails }) => {
    ...
    const getAcceptedProductDetail = async () => {
        try {
            const getData = await getAcceptedProductDetails();
    ...
    const removeProduct = () => {
        setGetAcceptedProductDetailsModal(false)
    ...
    return getAcceptedProductDetailsModal ? (
            ...
            <div className='flex items-center min-h-screen px-4 py-8'>
                <div className='relative w-full max-w-3xl p-6 mx-auto bg-white rounded-md shadow-lg'>
                    ...
                    <div className='text-center mb-4'>
                        <h4 className='text-xl font-semibold text-gray-800'>Accepted Products</h4>
                        <button
                            onClick={getAcceptedProductDetail}
                    ...
                    {processedProducts.length === 0 ? (
                        <div className='text-center text-gray-600'>No Accepted Shipments found or not yet fetched.</div>
                    ) : (
