            ...
            <div className='flex items-center min-h-screen px-4 py-8'>
                <div className='relative w-full max-w-lg p-4 mx-auto bg-white rounded-md shadow-lg'>
                    ...
                    <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
                        <h4 className="text-lg font-medium text-gray-800">Payment & Quality Check</h4>
                            ...
                            <div className="relative mt-3">
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        setTemperature({
                                            ...temperature,
                                            recordedtemp: e.target.value
                                        })
                                    }}
                                />
                            </div>

                            <button onClick={() => getConfirmDelivery()} className='block w-full mt-3 py-3 px-4 font-medium text-sm text-center text-white bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 rounded-lg ring-offset-2 ring-indigo-600 focus:ring-2'>
                                Payment
                            </button>
                        </form>
