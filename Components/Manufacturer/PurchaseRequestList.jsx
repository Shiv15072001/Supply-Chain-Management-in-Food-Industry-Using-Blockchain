...
import { fetchPurchaseRequestsForManufacturer } from "@/utils/firebaseHelpers";
import { ethers } from "ethers";


export default ({
    purchaseRequestListModal,
    setPurchaseRequestListModal,
    walletAddress,
}) => {
    ...
    //         const data = await fetchPurchaseRequestsForManufacturer(walletAddress);
    //         console.log(data)
    //         setRequests(data);
    //     };

    //     if (walletAddress) fetchRequests();
    // }, [walletAddress]);
    ...
    const removeData = async () => {
        setPurchaseRequestListModal(false)
        setRequests("")
    }

    return purchaseRequestListModal ? (
